...
public class CMainPanel extends JPanel {
    ...
    /**
     * Uses saveNote to save all open tabs to new or existing files
     */
    public void saveAllNotes() {
        int tabsNumber = tabbedPane.getTabCount() - 1;
        for (int i = tabsNumber; i >= 0; --i) {
            JTextArea textArea = (JTextArea) tabbedPane.getComponentAt(i);
